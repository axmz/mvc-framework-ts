...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      ...
      _this.events[eventName] = eventArr;
    };
...
function (_super) {
  ...
  User.buildUser = function (data) {
    return new User(new Eventing_1.default(), new ApiSync_1.default(rootUrl), new Attributes_1.default(data));
  };

  User.getUsers = function () {
    return new Collection_1.default(rootUrl, User.buildUser); // const users = new Collection<User, UserProps>(rootUrl, User.buildUser);
    // users.fetch();
    // return users.models
  };
...
},{"./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionsView.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  View.prototype.mapRegions = function (fragment) {
    ...
    for (var key in regionsMap) {
      var element = fragment.querySelector(regionsMap[key]);
...
var CollectionsView_1 = __importDefault(require("./CollectionsView"));
...
function (_super) {
  ...
  UserList.prototype.renderItem = function (model, parent) {
    new UserShow_1.default(parent, model).render();
  };
...
var collection = new Collection_1.default("http://localhost:3000/users", User_1.default.buildUser);
collection.on('change', function () {
  return new UserList_1.default(root, collection).render();
});
collection.fetch();
